...
export interface SeverDeployStackProps extends StackProps {
    ec2Role: aws_iam.Role
}

export class ServerDeployStack extends cdk.Stack{
    constructor(scope: Construct, id: string, props: SeverDeployStackProps) {
